...
"""autogenerated by genpy from multi_map_nav/MultiMapNavAction.msg. Do not edit."""
import codecs
import sys
...
import multi_map_nav.msg
import std_msgs.msg

class MultiMapNavAction(genpy.Message):
  _md5sum = "58ccdb8b3f29dfe05bb122b3bf166fea"
  _type = "multi_map_nav/MultiMapNavAction"
...
"""
  ...
  _slot_types = ['multi_map_nav/MultiMapNavActionGoal','multi_map_nav/MultiMapNavActionResult','multi_map_nav/MultiMapNavActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MultiMapNavAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = multi_map_nav.msg.MultiMapNavActionGoal()
      if self.action_result is None:
        self.action_result = multi_map_nav.msg.MultiMapNavActionResult()
      if self.action_feedback is None:
        self.action_feedback = multi_map_nav.msg.MultiMapNavActionFeedback()
    else:
      self.action_goal = multi_map_nav.msg.MultiMapNavActionGoal()
      self.action_result = multi_map_nav.msg.MultiMapNavActionResult()
      self.action_feedback = multi_map_nav.msg.MultiMapNavActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_goal.goal.target_map
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.target_map = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.target_map = str[start:end]
      _x = self
      start = end
      end += 12
