...
"""autogenerated by genpy from multi_map_nav/MultiMapNavGoal.msg. Do not edit."""
import codecs
import sys
...
class MultiMapNavGoal(genpy.Message):
  _md5sum = "e48063de98923cebf4a427d1072709d2"
  _type = "multi_map_nav/MultiMapNavGoal"
...
float64 w
"""
  __slots__ = ['target_map','target_pose']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MultiMapNavGoal, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.target_map = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.target_map = str[start:end]
      _x = self
      start = end
      end += 12
