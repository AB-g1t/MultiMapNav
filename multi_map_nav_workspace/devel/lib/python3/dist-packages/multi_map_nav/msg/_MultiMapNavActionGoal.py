...
"""autogenerated by genpy from multi_map_nav/MultiMapNavActionGoal.msg. Do not edit."""
import codecs
import sys
...
class MultiMapNavActionGoal(genpy.Message):
  _md5sum = "4b8454da1bf92618341335f0f3587a6f"
  _type = "multi_map_nav/MultiMapNavActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','multi_map_nav/MultiMapNavGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MultiMapNavActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = multi_map_nav.msg.MultiMapNavGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = multi_map_nav.msg.MultiMapNavGoal()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.goal.target_map = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.goal.target_map = str[start:end]
      _x = self
      start = end
      end += 12
